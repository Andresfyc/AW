...
function mostrarSaludo() {
	if (isset($_SESSION["login"]) && ($_SESSION["login"]===true)) {
		echo "<img id=\"prof_pic\" src=\"img/{$_SESSION["imagen"]}\" alt=\"imagen\" width=\"50\" height=\"50\"><p>Bienvenido, " . $_SESSION["nombre"] . "</p><a href='perfil.php'>Perfil</a> <a href='logout.php'>Salir</a>";
	} else {
